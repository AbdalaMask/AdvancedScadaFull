...
namespace AdvancedScada.HMI.Tools
{
    public static class NumericHelperHMI
    {
        ...
        public static double Val(string expression)
        {
            ...
            {
                if (double.TryParse(expression.Substring(0, size), out double testDouble))
                {
                    return testDouble;
                }
            }
        ...
        public static double Val(object expression)
        {
            ...
            if (double.TryParse(expression.ToString(), out double testDouble))
            {
                return testDouble;
            }
        ...
        {
            if (int.TryParse(expression.ToString(), out int testInt))
            {
                return testInt;
            }
            else
