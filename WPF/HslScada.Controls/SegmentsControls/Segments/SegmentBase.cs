    ...
    public class SegmentBase : UserControl, iSegment
    {
        ...
        static SegmentBase()
        {
            ...
            PenColorProperty = DependencyProperty.Register("PenColor", typeof(Color),
                typeof(SegmentBase), new PropertyMetadata(Colors.LightGray, VisualChanged));
            ...
            FillBrushProperty = DependencyProperty.Register("FillBrush", typeof(Brush),
                typeof(SegmentBase), new PropertyMetadata(new SolidColorBrush(Colors.WhiteSmoke), VisualChanged));
        ...
        /// <summary>
        /// A gap coef. between elements (a double starting from 0)
        /// </summary>
