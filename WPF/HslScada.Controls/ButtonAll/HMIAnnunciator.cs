...
namespace HslScada.Controls.ButtonAll
{
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            switch (MotorColors)
            {
                case MotorColor.Gray:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/HslScada.Controls;component/Images/AnnunciatorOff.png"));
                    drawingContext.DrawImage(imageSource, new Rect(0, 0, width, height));
                    break;
                case MotorColor.Green:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/HslScada.Controls;component/Images/AnnunciatorOn.png"));
                    drawingContext.DrawImage(imageSource, new Rect(0, 0, width, height));
                    break;
                default:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/HslScada.Controls;component/Images/AnnunciatorOff.png"));
