        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            switch (ButtonColors)
            {
                ...
                case ButtonColor.Green:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/AdvancedScada.WPF.Scada;component/Resources/17-4.bmp"));
                    drawingContext.DrawImage(imageSource, new Rect(0, 0, width, height));
                    break;
                case ButtonColor.Red:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/AdvancedScada.WPF.Scada;component/Resources/17-1.bmp"));
                    drawingContext.DrawImage(imageSource, new Rect(0, 0, width, height));
                    break;
                case ButtonColor.Orange:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/AdvancedScada.WPF.Scada;component/Resources/17-2.bmp"));
                    drawingContext.DrawImage(imageSource, new Rect(0, 0, width, height));
                    break;
                case ButtonColor.Yellow:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/AdvancedScada.WPF.Scada;component/Resources/17-3.bmp"));
                    drawingContext.DrawImage(imageSource, new Rect(0, 0, width, height));
                    break;
                case ButtonColor.BlueViolet:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/AdvancedScada.WPF.Scada;component/Resources/17-5.bmp"));
                    drawingContext.DrawImage(imageSource, new Rect(0, 0, width, height));
                    break;
                case ButtonColor.WhiteSmoke:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/AdvancedScada.WPF.Scada;component/Resources/17-6.bmp"));
                    drawingContext.DrawImage(imageSource, new Rect(0, 0, width, height));
                    break;
                case ButtonColor.Brown:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/AdvancedScada.WPF.Scada;component/Resources/18-3.bmp"));
                    drawingContext.DrawImage(imageSource, new Rect(0, 0, width, height));
                    break;
                case ButtonColor.DarkGreen:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/AdvancedScada.WPF.Scada;component/Resources/18-4.bmp"));
                    drawingContext.DrawImage(imageSource, new Rect(0, 0, width, height));
                    break;
                default:
                    imageSource = new BitmapImage(new Uri("pack://application:,,,/AdvancedScada.WPF.Scada;component/Resources/17-1.bmp"));
