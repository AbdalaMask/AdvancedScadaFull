...
namespace AdvancedScada.WPF.HMIControls.Motor
{
    public class HMIMotor : Control
    {
        ...
        public static DependencyProperty TextAlignmentProperty = DependencyProperty.Register("TextAlignment", typeof(TextAlignment), typeof(HMIMotor),
        ...
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register(
           "Value", typeof(bool), typeof(HMIMotor), new PropertyMetadata(false, OnCurrentReadingChanged));
        ...
        public static readonly DependencyProperty SuppressErrorDisplayProperty =
            DependencyProperty.Register("SuppressErrorDisplay", typeof(bool), typeof(HMIMotor), new PropertyMetadata(false));



        private static void OnCurrentReadingChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            HMIMotor Motor2 = (HMIMotor)d;
        ...
        public static readonly DependencyProperty PLCAddressValueProperty = DependencyProperty.Register(
           "PLCAddressValue", typeof(string), typeof(HMIMotor), new PropertyMetadata("0"));

        public static readonly DependencyProperty PLCAddressClickProperty = DependencyProperty.Register(
          "PLCAddressClick", typeof(string), typeof(HMIMotor), new PropertyMetadata("0"));
