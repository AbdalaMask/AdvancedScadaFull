...
{
    public class HMIAnnunciator : Control
    {
        ...
        public static DependencyProperty MotorColorsProperty = DependencyProperty.Register(
          "MotorColors", typeof(MotorColor), typeof(HMIAnnunciator),
       new FrameworkPropertyMetadata(MotorColor.Gray, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register(
          "Value", typeof(bool), typeof(HMIAnnunciator), new PropertyMetadata(false, OnCurrentReadingChanged));

        public static DependencyProperty TextAlignmentProperty = DependencyProperty.Register("TextAlignment", typeof(TextAlignment), typeof(HMIAnnunciator),
          new FrameworkPropertyMetadata(TextAlignment.Center, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty TextProperty = DependencyProperty.Register("Text", typeof(string), typeof(HMIAnnunciator),
        ...
        public static readonly DependencyProperty OutputTypesProperty =
            DependencyProperty.Register("OutputTypes", typeof(OutputType), typeof(HMIAnnunciator), new PropertyMetadata(OutputType.MomentarySet));
        ...
        public static readonly DependencyProperty SuppressErrorDisplayProperty =
            DependencyProperty.Register("SuppressErrorDisplay", typeof(bool), typeof(HMIAnnunciator), new PropertyMetadata(false));
        ...
        {
            HMIAnnunciator Motor2 = (HMIAnnunciator)d;
        ...
        public static readonly DependencyProperty PLCAddressValueProperty = DependencyProperty.Register(
           "PLCAddressValue", typeof(string), typeof(HMIAnnunciator), new PropertyMetadata("0"));

        public static readonly DependencyProperty PLCAddressClickProperty = DependencyProperty.Register(
        "PLCAddressClick", typeof(string), typeof(HMIAnnunciator), new PropertyMetadata("0"));
        [Category("Text")]
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            {
                var formattedText = new FormattedText(txt, System.Globalization.CultureInfo.CurrentUICulture, FlowDirection.LeftToRight,
