...
namespace AdvancedScada.Controls_Binding.ProcessAll.DrawAll
{
    internal class DrawGraphics2
    {
        ...
        internal void method_1(Graphics graphics_0, Rectangle rectangle_0, int int_0, Color color_0, Color color_1, int int_1, Color color_2, int int_2, Color color_3, Color color_4, int int_3, Color color_5, DAS_BorderGradientStyle das_BorderGradientStyle_0, long long_0, float float_0, float float_1, float float_2, float float_3)
        {
            LinearGradientBrush linearGradientBrush;
            Rectangle rectangle = new Rectangle(rectangle_0.Left + int_3, rectangle_0.Top + int_3, rectangle_0.Width - 2 * int_3, rectangle_0.Height - 2 * int_3);
            Rectangle rectangle1 = new Rectangle(rectangle_0.Left + int_3 + int_0, rectangle_0.Top + int_3 + int_0, rectangle_0.Width - 2 * (int_3 + int_0), rectangle_0.Height - 2 * (int_3 + int_0));
            ...
            Label2:
                ...
                if (int_2 > 0)
                {
                    linearGradientBrush = (das_BorderGradientStyle_0 != DAS_BorderGradientStyle.BGS_Linear ? new LinearGradientBrush(rectangle2, color_3, color_4, (float)(long_0 + 180L)) : new LinearGradientBrush(rectangle2, color_4, color_3, (float)long_0));
                    if (flag1)
                    {
                        linearGradientBrush.Blend = float0;
                    }
        ...
        Label0:
            if (int_3 > 0)
            {
                ...
                graphicsPath7.AddEllipse(rectangle_0);
        ...
        internal void method_2(Graphics graphics_0, Rectangle rectangle_0, int int_0, int int_1, Color color_0, Color color_1, int int_2, Color color_2, int int_3, Color color_3, Color color_4, int int_4, Color color_5, DAS_BorderGradientStyle das_BorderGradientStyle_0, long long_0, float float_0, float float_1, float float_2, float float_3)
        {
            LinearGradientBrush linearGradientBrush;
            float height;
            float single;
            ...
            int int0 = int_0 - int_4;
            GraphicsPath graphicsPath = new GraphicsPath();
            this.method_4(graphicsPath, rectangle, int0);
            int0 = int_0 - int_4 - int_1;
            GraphicsPath graphicsPath1 = new GraphicsPath();
            this.method_4(graphicsPath1, rectangle1, int0);
            int0 = int_0 - int_4 - int_1 - int_2;
            GraphicsPath graphicsPath2 = new GraphicsPath();
            this.method_4(graphicsPath2, rectangle2, int0);
            int0 = int_0 - int_4 - int_1 - int_2 - int_3;
            GraphicsPath graphicsPath3 = new GraphicsPath();
            this.method_4(graphicsPath3, rectangle3, int0);
            if (das_BorderGradientStyle_0 == DAS_BorderGradientStyle.BGS_Flat)
            {
                PointF[] left = new PointF[5];
                left[0].X = (float)rectangle.Left;
        ...
        Label0:
            if (int_4 > 0)
            {
                SolidBrush solidBrush8 = new SolidBrush(color_5);
                GraphicsPath graphicsPath7 = new GraphicsPath();
                this.method_4(graphicsPath7, rectangle_0, int_0);
                Region region22 = new Region(graphicsPath7);
                region22.Exclude(graphicsPath);
                graphics_0.FillRegion(solidBrush8, region22);
                Pen pen14 = new Pen(solidBrush8);
        ...
        internal void method_3(Graphics graphics_0, Rectangle rectangle_0, DAS_ShapeStyle das_ShapeStyle_0, GraphicsPath graphicsPath_0, Color color_0, Color color_1, DAS_BkGradientStyle das_BkGradientStyle_0, int int_0, float float_0, int int_1, int int_2, float float_1)
        {
            RectangleF rectangleF;
            float height;
            float single;
            if (das_BkGradientStyle_0 != DAS_BkGradientStyle.BKGS_Polygon && das_BkGradientStyle_0 != DAS_BkGradientStyle.BKGS_Sphere)
            {
                if (das_BkGradientStyle_0 != DAS_BkGradientStyle.BKGS_Sphere2)
                {
                    if (das_BkGradientStyle_0 != DAS_BkGradientStyle.BKGS_Linear)
                    {
                        if (das_BkGradientStyle_0 != DAS_BkGradientStyle.BKGS_Linear2)
                        {
                            if (das_BkGradientStyle_0 == DAS_BkGradientStyle.BKGS_Shine)
                            {
                                ...
                                if (das_ShapeStyle_0 == DAS_ShapeStyle.SS_Rect)
                                {
                                    graphicsPath.AddRectangle(rectangle);
                                }
                                else if (das_ShapeStyle_0 == DAS_ShapeStyle.SS_RoundRect)
                                {
                                    this.method_4(graphicsPath, rectangle, int_1);
                                }
                                else if (das_ShapeStyle_0 != DAS_ShapeStyle.SS_Circle)
                                {
                                ...
                                if (das_ShapeStyle_0 == DAS_ShapeStyle.SS_Circle)
                                {
                                ...
                                {
                                    graphics_0.FillEllipse(pathGradientBrush, rectangle);
                                }
                                pathGradientBrush.Dispose();
                            }
                            return;
            ...
            {
                rectangleF = (das_ShapeStyle_0 == DAS_ShapeStyle.SS_Circle ? new RectangleF((float)(rectangle_0.Left - 1), (float)(rectangle_0.Top - 1), (float)(rectangle_0.Width + 2), (float)(rectangle_0.Height + 2)) : new RectangleF((float)rectangle_0.Left - 0.415f * (float)rectangle_0.Width / 2f, (float)rectangle_0.Top - 0.415f * (float)rectangle_0.Height / 2f, 1.415f * (float)rectangle_0.Width, 1.415f * (float)rectangle_0.Height));
        ...
        internal void method_4(GraphicsPath graphicsPath_0, Rectangle rectangle_0, int int_0)
        {
            int int0 = int_0;
        ...
        internal void method_5(Graphics graphics_0, Rectangle rectangle_0, DAS_ShapeStyle das_ShapeStyle_0, int int_0, int int_1, int int_2, Color color_0, Color color_1, int int_3, Color color_2, int int_4, Color color_3, Color color_4, int int_5, Color color_5, DAS_BorderGradientStyle das_BorderGradientStyle_0, long long_0, float float_0, float float_1, float float_2, float float_3)
        {
            LinearGradientBrush linearGradientBrush;
            float height;
            float single;
            ...
            if (das_ShapeStyle_0 == DAS_ShapeStyle.SS_Rect)
            {
                this.method_0(graphics_0, rectangle_0, int_2, color_0, color_1, int_3, color_2, int_4, color_3, color_4, int_5, color_5, das_BorderGradientStyle_0, (int)long_0, float_0, float_1, float_2, float_3);
                return;
            }
            if (das_ShapeStyle_0 == DAS_ShapeStyle.SS_RoundRect)
            {
                this.method_2(graphics_0, rectangle_0, int_0, int_2, color_0, color_1, int_3, color_2, int_4, color_3, color_4, int_5, color_5, das_BorderGradientStyle_0, long_0, float_0, float_1, float_2, float_3);
                return;
            }
            if (das_ShapeStyle_0 == DAS_ShapeStyle.SS_Circle)
            {
                this.method_1(graphics_0, rectangle_0, int_2, color_0, color_1, int_3, color_2, int_4, color_3, color_4, int_5, color_5, das_BorderGradientStyle_0, long_0, float_0, float_1, float_2, float_3);
                return;
            }
            Rectangle rectangle = new Rectangle(rectangle_0.Left + int_5, rectangle_0.Top + int_5, rectangle_0.Width - 2 * int_5, rectangle_0.Height - 2 * int_5);
            Rectangle rectangle1 = new Rectangle(rectangle_0.Left + int_5 + int_2, rectangle_0.Top + int_5 + int_2, rectangle_0.Width - 2 * (int_5 + int_2), rectangle_0.Height - 2 * (int_5 + int_2));
            Rectangle rectangle2 = new Rectangle(rectangle_0.Left + int_5 + int_2 + int_3, rectangle_0.Top + int_5 + int_2 + int_3, rectangle_0.Width - 2 * (int_5 + int_2 + int_3), rectangle_0.Height - 2 * (int_5 + int_2 + int_3));
            Rectangle rectangle3 = new Rectangle(rectangle_0.Left + int_5 + int_2 + int_3 + int_4, rectangle_0.Top + int_5 + int_2 + int_3 + int_4, rectangle_0.Width - 2 * (int_5 + int_2 + int_3 + int_4), rectangle_0.Height - 2 * (int_5 + int_2 + int_3 + int_4));
            int int1 = int_1 + int_5 + int_2 + int_3 + int_4;
            GraphicsPath graphicsPath = new GraphicsPath();
            this.method_6(graphicsPath, rectangle_0, das_ShapeStyle_0, int1, int_5);
            GraphicsPath graphicsPath1 = new GraphicsPath();
            this.method_6(graphicsPath1, rectangle_0, das_ShapeStyle_0, int1, int_5 + int_2);
            GraphicsPath graphicsPath2 = new GraphicsPath();
            this.method_6(graphicsPath2, rectangle_0, das_ShapeStyle_0, int1, int_5 + int_2 + int_3);
            GraphicsPath graphicsPath3 = new GraphicsPath();
            this.method_6(graphicsPath3, rectangle_0, das_ShapeStyle_0, int1, int_5 + int_2 + int_3 + int_4);
            if (das_BorderGradientStyle_0 == DAS_BorderGradientStyle.BGS_Flat)
            {
                PointF[] left = new PointF[5];
                left[0].X = (float)rectangle.Left;
                ...
                if (das_BorderGradientStyle_0 != DAS_BorderGradientStyle.BGS_Linear)
                {
                    ...
                    if (das_BorderGradientStyle_0 == DAS_BorderGradientStyle.BGS_Path)
                    {
                        ...
                        if (int_2 > 0)
                        {
                            ...
                            {
                                single = 0f;
                                height = (float)(Math.Cos(long0) * (double)(rectangle.Width - int_2) / 2);
                            }
                            else if (Math.Abs(Math.Cos(long0)) >= 1E-10)
                            {
                                height = (float)((double)(rectangle.Height - int_2) / (2 * Math.Tan(long0)));
                                single = (float)(Math.Tan(long0) * (double)(rectangle.Width - int_2) / 2);
                                height = (Math.Cos(long0) >= 0 ? Math.Abs(height) : -Math.Abs(height));
                                single = (Math.Sin(long0) >= 0 ? Math.Abs(single) : -Math.Abs(single));
                                if (height < -((float)(rectangle.Width - int_2) / 2f))
                                {
                                    height = -((float)(rectangle.Width - int_2) / 2f);
                                }
                                else if (height > (float)(rectangle.Width - int_2) / 2f)
                                {
                                    height = (float)(rectangle.Width - int_2) / 2f;
                                }
                                if (single < -((float)(rectangle.Height - int_2) / 2f))
                                {
                                    single = -((float)(rectangle.Height - int_2) / 2f);
                                }
                                else if (single > (float)(rectangle.Height - int_2) / 2f)
                                {
                                    single = (float)(rectangle.Height - int_2) / 2f;
                                }
                            }
                            ...
                            {
                                height = 0f;
                                single = (float)(Math.Sin(long0) * (double)(rectangle.Height - int_2) / 2);
                            }
                            x.X = x.X + height * float_1;
                            x.Y = x.Y + single * float_1;
                            if (flag)
                        ...
                        if (int_4 > 0)
                        {
                            ...
                            {
                                height1 = 0f;
                                width = (float)(Math.Cos(num) * (double)(rectangle2.Width - int_4) / 2);
                            }
                            else if (Math.Abs(Math.Cos(num)) >= 1E-10)
                            {
                                width = (float)((double)(rectangle2.Height - int_4) / (2 * Math.Tan(num)));
                                height1 = (float)(Math.Tan(num) * (double)(rectangle2.Width - int_4) / 2);
                                width = (Math.Cos(num) >= 0 ? Math.Abs(width) : -Math.Abs(width));
                                height1 = (Math.Sin(num) >= 0 ? Math.Abs(height1) : -Math.Abs(height1));
                                if (width < -((float)(rectangle2.Width - int_4) / 2f))
                                {
                                    width = -((float)(rectangle2.Width - int_4) / 2f);
                                }
                                else if (width > (float)(rectangle2.Width - int_4) / 2f)
                                {
                                    width = (float)(rectangle2.Width - int_4) / 2f;
                                }
                                if (height1 < -((float)(rectangle2.Height - int_4) / 2f))
                                {
                                    height1 = -((float)(rectangle2.Height - int_4) / 2f);
                                }
                                else if (height1 > (float)(rectangle2.Height - int_4) / 2f)
                                {
                                    height1 = (float)(rectangle2.Height - int_4) / 2f;
                                }
                            }
                            ...
                            {
                                width = 0f;
                                height1 = (float)(Math.Sin(num) * (double)(rectangle2.Height - int_4) / 2);
                            }
                            y.X = y.X + width * float_1;
                            y.Y = y.Y + height1 * float_1;
                            if (flag)
                            {
                                color4.Blend = blend;
                            }
        ...
        Label0:
            if (int_5 > 0)
            {
                SolidBrush solidBrush8 = new SolidBrush(color_5);
                GraphicsPath graphicsPath7 = new GraphicsPath();
                this.method_6(graphicsPath7, rectangle_0, das_ShapeStyle_0, int_1 + int_5 + int_2 + int_3 + int_4, 0);
                Region region22 = new Region(graphicsPath7);
                region22.Exclude(graphicsPath);
                graphics_0.FillRegion(solidBrush8, region22);
                Pen pen14 = new Pen(solidBrush8);
