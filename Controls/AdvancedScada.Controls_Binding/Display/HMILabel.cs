...
{
    [Designer(typeof(HMILabelDesigner))]
    public class HMILabel : System.Windows.Forms.Label
    {
        ...
        public HMILabel()
        {
            ...
            if (base.ForeColor == Color.FromKnownColor(KnownColor.ControlText) || ForeColor == Color.FromArgb(0, 0, 0))
                ForeColor = Color.WhiteSmoke;
        }

        protected override void Dispose(bool disposing)
        {
            if (m_KeypadFont != null) m_KeypadFont.Dispose();
    ...
    internal class HMILabelDesigner : ControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (null == actionLists)
                {
                    ...
                    actionLists.Add(new HMILabelActionList(Component));
                }
    ...
    internal class HMILabelActionList : DesignerActionList
    {
        private readonly HMILabel _HMILabel;

        private DesignerActionUIService designerActionUISvc;

        //The constructor associates the control with the smart tag list.
        public HMILabelActionList(IComponent component)
            : base(component)
        {
            _HMILabel = component as HMILabel;
        ...
        {
            get { return _HMILabel.TextAlign; }
            set { _HMILabel.TextAlign = value; }
        }

        public string PLCAddressValue
        {
            get { return _HMILabel.PLCAddressValue; }
            set { _HMILabel.PLCAddressValue = value; }
        }

        public Color BackColor
        {
            get { return _HMILabel.BackColor; }
            set { _HMILabel.BackColor = value; }
        }

        public Color ForeColor
        {
            get { return _HMILabel.ForeColor; }
            set { _HMILabel.ForeColor = value; }
        }

        public Font Font
        {
            get { return _HMILabel.Font; }
            set { _HMILabel.Font = value; }
        }

        public string Text
        {
            get { return _HMILabel.Text; }
            set { _HMILabel.Text = value; }
        }

        public bool AutoSize
        {
            get { return _HMILabel.AutoSize; }
            set { _HMILabel.AutoSize = value; }
        }
        ...
        private void ShowTagList()
        {
            ...
            {
                var pd = TypeDescriptor.GetProperties(_HMILabel)["PLCAddressValue"];
                pd.SetValue(_HMILabel, tagName);
            };
