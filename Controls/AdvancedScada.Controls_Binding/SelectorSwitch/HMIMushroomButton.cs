...
namespace AdvancedScada.Controls_Binding.SelectorSwitch
{
    ...
    internal class HMIMushroomButtonDesigner : ControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (null == actionLists)
                {
                    ...
                    actionLists.Add(new HMIMushroomButtonActionList(Component));
                }
    ...
    internal class HMIMushroomButtonActionList : DesignerActionList
    {
        private readonly HMIMushroomButton _HMIbutton;
