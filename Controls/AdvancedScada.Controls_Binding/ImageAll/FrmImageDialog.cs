...
using AdvancedScada.Controls_Binding.ImageAll;
using System;
...
namespace Scada.Scheme.Model.PropertyGrid
{
    ...
    {
        private readonly Dictionary<string, Image> images=new Dictionary<string, Image>(); // словарь изображений схемы
        ...
        /// </summary>
        public FrmImageDialog(Dictionary<string, Image> images)
            : this()
        {
        ...
        /// </summary>
        public FrmImageDialog(string imageName)
            : this()
        {
