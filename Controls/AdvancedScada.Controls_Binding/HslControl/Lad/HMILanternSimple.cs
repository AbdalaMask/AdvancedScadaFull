...
namespace AdvancedScada.Controls_Binding.HslControl.Lad
{
    public class HMILanternSimple : HslLanternSimple, IPropertiesControls
    {
        ...
        public bool Value
        {
            ...
            set
            {
                if (m_Value != value)
                {
                    ...
                    if (m_Value)
                    {
                        LanternBackground = System.Drawing.Color.LimeGreen;
                    }
                    else
                    {
                        LanternBackground = System.Drawing.Color.Red;
                    }
