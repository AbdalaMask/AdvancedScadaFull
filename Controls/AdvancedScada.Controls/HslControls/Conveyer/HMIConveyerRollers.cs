...
using AdvancedScada.Controls.HslControls.Conveyer;
using AdvancedScada;
using AdvancedScada.Controls;
using AdvancedScada.Controls.HslControls;
using MfgControl.AdvancedHMI.Controls;

namespace AdvancedScada.Controls.HslControls.Conveyer
{
    public class HMIConveyerRollers : HslConveyerRollers
    {
