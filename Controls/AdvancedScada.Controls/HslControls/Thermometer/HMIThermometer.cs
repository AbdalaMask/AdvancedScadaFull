...
using AdvancedScada.Controls.HslControls.Thermometer;
using AdvancedScada;
using AdvancedScada.Controls;
using AdvancedScada.Controls.HslControls;
using MfgControl.AdvancedHMI.Controls;

namespace AdvancedScada.Controls.HslControls.Thermometer
{
    public class HMIThermometer : HslThermometer
    {
