...
{
    public class LS_FENET : IDriverAdapterV2, IDisposable
    {
        ...
        /// <returns></returns>
        public byte[] ReadBytes(string type, int strVar, int RequestCount)
        {
            string RequestAddress = $"%{type + strVar}";
            int iLen = 0;
            ...
            string ReqData = $"{Length:D4}{strTmp}{RequestCount:D4}";
        ...
        protected virtual void Dispose(bool isDisposing)
        {
            if (isDisposing)
            {
                ...
                EthernetAdaper.Dispose();
                SerialAdaper.Dispose();
            }
