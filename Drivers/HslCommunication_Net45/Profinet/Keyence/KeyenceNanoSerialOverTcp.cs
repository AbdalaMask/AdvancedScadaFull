...
{
    /// <summary>
    /// 基恩士KV上位链路串口通信的对象,适用于Nano系列串口数据,以及L20V通信模块，本类是基于tcp通信方式的类
    /// </summary>
    /// <remarks>
    /// 地址的输入的格式说明如下：
    /// <list type="table">
    ...
    /// </list>
    /// </remarks>
    public class KeyenceNanoSerialOverTcp : NetworkDeviceSoloBase<KeyenceNanoByteTransform>
    {
        #region Constructor
        ...
        {
            // 建立通讯连接{CR/r}
            var result = ReadFromCoreServer(socket, _buildConnectCmd);
