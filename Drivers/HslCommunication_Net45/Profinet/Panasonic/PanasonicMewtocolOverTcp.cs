...
{
    /// <summary>
    /// 松下PLC的数据交互协议，采用Mewtocol协议通讯，基于Tcp实现的机制
    /// </summary>
    /// <remarks>
    /// 触点地址的输入的格式说明如下：
    /// <list type="table">
    ...
    /// </list>
    /// </remarks>
    public class PanasonicMewtocolOverTcp : NetworkDeviceSoloBase<RegularByteTransform>
    {
        #region Constructor
