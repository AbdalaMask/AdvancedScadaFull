...
namespace HslCommunication.MQTT
{
    ...
    /// </summary>
    /// <remarks>
    /// 这是一个MQTT的客户端实现，严格参照MQTT协议的3.1.1版本设计实现的。服务器可以是其他的组件提供的，其他的可以参考示例
    /// </remarks>
    /// <example>
    ...
    public class MqttClient : NetworkXBase
    {
        ...
        /// 参照 <see cref="MqttClient"/> 的示例说明。
        /// <code lang="cs" source="HslCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test" title="简单的实例化" />
        /// <code lang="cs" source="HslCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test6" title="订阅示例" />
        /// </example>
